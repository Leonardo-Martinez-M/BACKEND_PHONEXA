...
async function main() {
    console.log(...oo_oo(`2664567870_6_2_6_46_4`, '🌱 Iniciando seed de datos...'));
    console.log(...oo_oo(`2664567870_9_2_9_49_4`, '🧹 Limpiando datos existentes...'));
    await prisma.quizz.deleteMany();
    await prisma.aeronauticalAlphabetCard.deleteMany();
    console.log(...oo_oo(`2664567870_12_2_12_34_4`, '✅ Datos limpiados'));
    ...
    console.log(...oo_oo(`2664567870_176_2_176_64_4`, '🪶 Creando tarjetas del alfabeto aeronáutico...'));
    ...
    console.log(...oo_oo(`2664567870_185_2_185_35_4`, '✅ Tarjetas creadas'));
    const memoryQuiz = [
        {
            id: 1,
            answer: 'a',
    ...
    console.log(...oo_oo(`2664567870_398_2_398_51_4`, '🧩 Creando datos de memory quiz...'));
    ...
    console.log(...oo_oo(`2664567870_478_2_478_48_4`, '🧠 Creando preguntas de quiz...'));
    ...
    console.log(...oo_oo(`2664567870_487_2_487_36_4`, '✅ Preguntas creadas'));
    console.log(...oo_oo(`2664567870_489_2_489_49_4`, '🎉 Seed completado exitosamente!'));
}
main()
    .catch((e) => {
    console.error(...oo_tx(`2664567870_494_4_494_48_11`, '❌ Error durante el seed:', e));
    process.exit(1);
})
    .finally(async () => {
